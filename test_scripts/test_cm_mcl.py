...
from co_expander import (
    COExpanderCMModel, GNNEncoder, COExpanderEnv, COExpanderMClSolver, COExpanderDecoder
)
...
WEIGHT_PATH_DICT = {
    "RB-SMALL": "weights/cm_mcl_rb-small_sparse.pt",
    "RB-LARGE": "weights/cm_mcl_rb-large_sparse.pt",
    "RB-GIANT": "weights/cm_mcl_rb-large_sparse.pt",
    "TWITTER": "weights/cm_mcl_rb-small_sparse.pt",
    "COLLAB": "weights/cm_mcl_rb-small_sparse.pt"
}
...
if __name__ == "__main__":
    ...
    solver = COExpanderMClSolver(model=model)
