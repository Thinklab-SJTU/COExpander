...
from co_expander import (
    COExpanderGNNModel, GNNEncoder, COExpanderEnv, COExpanderMISSolver, COExpanderDecoder
)
...
WEIGHT_PATH_DICT = {
    "RB-SMALL": "weights/gnn_mis_rb-small_sparse.pt",
    "RB-LARGE": "weights/gnn_mis_rb-large_sparse.pt",
    "RB-GIANT": "weights/gnn_mis_rb-large_sparse.pt",
    "ER-700-800": "weights/gnn_mis_er-700-800_sparse.pt",
    "ER-1400-1600": "weights/gnn_mis_er-700-800_sparse.pt",
}

# main
if __name__ == "__main__":
    rlsa_settings = RLSA_SETTINGS_DICT[TEST_TYPE]
    model = COExpanderGNNModel(
        env=COExpanderEnv(
